...
# kubectl run docker-hello-google --image=us.gcr.io/${PROJECT_NAME}/hello:$CIRCLE_SHA1
...
kubectl patch deployment docker-hello-google -p '{"spec":{"template":{"spec":{"containers":[{"name":"docker-hello-google-cluster","image":"us.gcr.io/circle-ctl-test-162119/hello"}]}}}}'
kubectl expose deployment docker-hello-google --type="LoadBalancer" --port=80 --target-port=3000
