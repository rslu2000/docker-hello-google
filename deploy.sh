...
kubectl patch deployment gke-docker-hello-google--default-pool-1434b3f4-nmz2 -p '{"spec":{"template":{"spec":{"containers":[{"name":"docker-hello-google-cluster","image":"us.gcr.io/circle-ctl-test-162119/hello:'"$CIRCLE_SHA1"'"}]}}}}'
